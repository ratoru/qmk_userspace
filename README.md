...
- [Cyclotab](https://getreuer.info/posts/keyboards/cyclotab). Sends `Cmd+Tab`but holds the modifier between consecutive keypresses for easy app/window switching.
