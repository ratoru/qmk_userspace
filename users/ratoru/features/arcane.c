...
void process_arcane(uint16_t keycode, uint8_t mods, bool is_idle) {
    ...
    switch (keycode) {
        ...
        case KC_ENT:
            ...
            break;
        case KC_A:
            MAGIC_STRING(SS_TAP(X_BSPC) SS_LALT(SS_TAP(X_QUOTE)) SS_TAP(X_A), KC_A);
            break;
        case KC_B:
        ...
        case KC_N:
            ...
            break;
        case KC_O:
            MAGIC_STRING(SS_TAP(X_BSPC) SS_LALT(SS_TAP(X_QUOTE)) SS_TAP(X_O), KC_O);
            break;
        case KC_P:
        ...
        case KC_T:
            ...
            break;
        case KC_U:
            MAGIC_STRING(SS_TAP(X_BSPC) SS_LALT(SS_TAP(X_QUOTE)) SS_TAP(X_U), KC_U);
            break;
        case KC_V:
            MAGIC_STRING(/*v*/ "v", KC_V);
            break;
        case KC_W:
            MAGIC_STRING(/*w*/ "w", KC_W);
            break;
        case KC_X:
